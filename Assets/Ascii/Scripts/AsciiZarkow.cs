...
namespace AsciiImageEffect
{
	...
	public sealed class AsciiZarkow : MonoBehaviour
	{
		...
		public float One = 9.0f;
		public float Two = 10.0f;
		...
		private void OnRenderImage(RenderTexture source, RenderTexture destination)
		{
			if (material != null)
			{
				material.SetFloat(@"monitorWidthMultiplier", (Screen.width / One));
				material.SetFloat(@"monitorHeightMultiplier", (Screen.height /Two));
